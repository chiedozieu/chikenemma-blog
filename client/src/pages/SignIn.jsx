    ...
    <div className='min-h-screen mt-20'>
      <div className="flex  p-3 max-w-4xl mx-auto flex-1 gap-6 flex-col md:flex-row md:items-center">
        <div className="">
          ...
          <p className="text-sm mt-5">Get the Latest News and Views. Breaking Stories and Expert Analysis</p>
        </div>
        <div className="flex-1">
          ...
          <div className="flex gap-2 mt-5 text-sm"><span>Don't have an account?</span><Link to='/sign-up' className="text-blue-500">Sign Up</Link>
          </div>
